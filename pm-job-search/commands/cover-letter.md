...
/cover-letter -- Générateur de lettre de motivation

Inputs attendus :
- Texte de l'offre d'emploi
- URL de l'entreprise
- CV optionnel : si fourni, remplace cv-context.md

Output : 3 variantes de lettre de motivation (angle meta-skills / problème-solution / actualité entreprise), 200-250 mots chacune.
